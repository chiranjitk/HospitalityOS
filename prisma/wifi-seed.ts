  ...
  await prisma.wiFiSession.createMany({
    data: [
      ...
      // Terminated sessions (2)
      {
        ...
        deviceName: 'Rina-Unknown-Device',
        deviceType: 'other',
        startTime: hour(-6),
        endTime: hour(-5),
