  ...
  apps: [
    {
      name: 'staysuite-main',
      script: 'node',
      args: '--max-old-space-size=1536 node_modules/next/dist/bin/next start -p 3000',
      cwd: APP_DIR,
      watch: false,
      instances: 1,
      autorestart: true,
      ...
      env: {
        ...
        STAYSUITE_SCRIPTS_DIR: `${APP_DIR}/scripts/staysuite_core`,
        NETWORK_SCRIPTS_DIR: `${APP_DIR}/scripts/network`,
      },
    ...
    },
    {
      ...
      script: 'index.ts',
      interpreter: '/usr/local/bin/bun',
      cwd: `${APP_DIR}/mini-services/memory-watcher`,
      watch: false,
      autorestart: true,
      max_memory_restart: '200M',
      error_file: '/home/z/my-project/.pm2/logs/memory-watcher-error.log',
      out_file: '/home/z/my-project/.pm2/logs/memory-watcher-out.log',
    },
  ],
};
