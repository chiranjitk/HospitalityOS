...
app.use('*', async (c, next) => {
  // No auth needed for health, status, service control, sync, cache, and config endpoints
  const noAuthPaths = ['/health', '/api/status', '/api/sync'];
  const noAuthPrefixes = ['/api/service/', '/api/cache'];
