...
[[ "$DN_CEIL_OVERRIDE" -gt 0 ]] && PARAM_LOG="$PARAM_LOG -e $DN_CEIL_OVERRIDE"
[[ "$UP_CEIL_OVERRIDE" -gt 0 ]] && PARAM_LOG="$PARAM_LOG -E $UP_CEIL_OVERRIDE"
...
DN_GUAR=${DN_GUAR}
UP_GUAR=${UP_GUAR}
DN_CEIL_OVERRIDE=${DN_CEIL_OVERRIDE}
UP_CEIL_OVERRIDE=${UP_CEIL_OVERRIDE}
