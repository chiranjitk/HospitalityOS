...
const PUBLIC_PATHS = [
  ...
  '/api/wifi/captive/',     // Captive portal auth (public, guest-facing)
  ...
  // Public website (generated by website builder)
  '/site',                // Public hotel website pages
  '/api/site/',            // Public website API endpoint
  // Page routes
  '/login',
  '/signup',
  '/reset-password',
